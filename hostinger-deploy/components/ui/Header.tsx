...
function Header({ className }: HeaderProps) {
  ...
  const navItems = useMemo(() => [
    ...
    },
    {
      ...
      subItems: [
        { label: 'Relocation Services', href: '/concierge/relocation' },
                    ...
                    >
                      ...
                      {vendor ? (
                        <Link
                          ...
                          className="block px-4 py-3 text-sm text-neutral-700 hover:bg-neutral-50 transition-colors border-b border-neutral-100"
                          onClick={() => setIsAccountMenuOpen(false)}
                        >
                          <div className="font-semibold truncate">{vendor.name}</div>
                          <div className="text-xs text-neutral-500 mt-0.5">View Profile</div>
                        </Link>
                      ) : (
                        <div className="px-4 py-3 text-sm border-b border-neutral-100">
                          <div className="font-semibold text-neutral-900">{user.email}</div>
                          <div className="text-xs text-neutral-500 mt-0.5">Account</div>
                        </div>
                      )}
