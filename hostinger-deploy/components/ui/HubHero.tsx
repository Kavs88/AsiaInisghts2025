...
export default function HubHero({
    ...
    return (
        <section className={cn(
            ...
            {/* Content Layer */}
            <div className="container-custom relative z-20 py-24 lg:py-32">
                <div className="max-w-4xl animate-fade-up">
                    <h1 className="text-5xl lg:text-7xl xl:text-8xl font-black text-white mb-6 leading-[0.9] tracking-tight">
                        {title}
                    </h1>
