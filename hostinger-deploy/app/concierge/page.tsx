...
export default function ConciergeHomePage() {
  return (
    <main id="main-content" className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-r from-primary-600 to-secondary-600 text-white py-12 sm:py-16 md:py-20 lg:py-32">
        <div className="container-custom">
          <div className="max-w-4xl">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl xl:text-9xl font-black mb-6 sm:mb-8 leading-[0.9] tracking-tight">
              Concierge
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              {/* QA FIX: Changed "View Services" to scroll to services section instead of placeholder page
                  REASON: Services page shows "Coming Soon" placeholder, breaking user expectation
                  RESULT: User scrolls to services section on same page, avoiding broken journey
              */}
              <Link
                href="#our-services"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-10 border border-neutral-300 shadow-sm hover:shadow-md transition-shadow">
              ...
              <ul className="space-y-3 text-neutral-700">
                {/* TODO: Add specific expat services content */}
              ...
              <Link
                href="#get-in-touch"
                className="inline-flex items-center justify-center px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white font-bold rounded-xl transition-all duration-200 mt-6"
              >
                Get Started
              </Link>
            </div>
            ...
            <div className="bg-white rounded-2xl p-10 border border-neutral-300 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl lg:text-3xl font-bold text-neutral-900">For Retirees</h3>
              </div>
              <ul className="space-y-3 text-neutral-700">
                {/* TODO: Add specific retiree services content */}
                <li className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-primary-600 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
            ...
            <div className="bg-white rounded-2xl p-10 border border-neutral-300 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl lg:text-3xl font-bold text-neutral-900">For Digital Nomads</h3>
              </div>
              <ul className="space-y-3 text-neutral-700">
                {/* TODO: Add specific digital nomad services content */}
                <li className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-primary-600 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
            ...
            <div className="bg-white rounded-2xl p-10 border border-neutral-300 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl lg:text-3xl font-bold text-neutral-900">For Entrepreneurs</h3>
              </div>
              <ul className="space-y-3 text-neutral-700">
                {/* TODO: Add specific entrepreneur services content */}
                <li className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-primary-600 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
