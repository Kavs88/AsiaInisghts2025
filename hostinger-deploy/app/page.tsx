      ...
      <section id="explore-asia-insights" className="py-20 bg-white">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto justify-items-center">
            {/* Markets - Active
                PHASE 1 STEP 2: Visual hierarchy - prominent borders, stronger shadows, hover scale effect
                BORDER: border-primary-500 (brand blue #0054b6)
                SHADOW: shadow-lg hover:shadow-xl
                HOVER: hover:scale-105 transition-transform
                OPACITY: opacity-100 (full opacity)
                PHASE 1 STEP 3: Content & CTAs verified
                DESCRIPTION: "Discover local vendors, products, and market events" (action-oriented, exact match)
                CTA: "Explore Markets" with arrow icon (exact match, brand blue #0054b6)
                LINK: href="/markets" (correct route)
            */}
            <Link
              href="/markets"
            ...
            >
              ...
              <p className="text-neutral-600 mb-4 leading-relaxed">Discover local businesses, products, and market events</p>
            ...
            {/* Concierge - Active
                ...
                OPACITY: opacity-100 (full opacity)
                PHASE 1 STEP 3: Content & CTAs verified
                DESCRIPTION: "Get personalized support for your Southeast Asia journey" (action-oriented, exact match)
                CTA: "Explore Concierge" with arrow icon (exact match, brand blue #0054b6)
                LINK: href="/concierge" (correct route)
            */}
            <Link
              href="/concierge"
              className="w-full bg-white rounded-2xl p-8 border-2 border-primary-500 shadow-lg hover:shadow-xl hover:scale-105 transition-transform opacity-100 group"
            ...
            {/* Business - Active
                PHASE 2: Business Section added
                BORDER: border-primary-500 (brand blue #0054b6)
                SHADOW: shadow-lg hover:shadow-xl
                HOVER: hover:scale-105 transition-transform
                OPACITY: opacity-100 (full opacity)
                DESCRIPTION: "Discover local businesses, services, and professional networks" (action-oriented)
                CTA: "Explore Business" with arrow icon (brand blue #0054b6)
                LINK: href="/businesses" (correct route)
            */}
            <Link
              href="/businesses"
              className="w-full bg-white rounded-2xl p-8 border-2 border-primary-500 shadow-lg hover:shadow-xl hover:scale-105 transition-transform opacity-100 group"
            >
              ...
              <h3 className="text-2xl font-bold text-neutral-900 mb-2">Business</h3>
