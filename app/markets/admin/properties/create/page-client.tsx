...
import { createProperty, CreatePropertyData, PropertyType } from '@/lib/actions/admin-crud'

const PROPERTY_TYPES: PropertyType[] = ['apartment', 'house', 'condo', 'villa', 'commercial', 'land', 'other']

const emptyForm: CreatePropertyData = {
  address: '',
  type: 'apartment',
...
export default function AdminPropertyCreatePageClient() {
  ...
  const [formData, setFormData] = useState<CreatePropertyData>(emptyForm)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (!formData.address || !formData.type || !formData.price) {
        setError('Address, type, and price are required')
        setLoading(false)
        return
      }
    ...
    <main className="min-h-screen bg-neutral-50">
      ...
      <div className="container-custom max-w-4xl py-8">
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold text-neutral-900 mb-2">Add Property</h1>
            <p className="text-neutral-600">Create a new property listing</p>
          </div>
        ...
        {success && (
          <div className="mb-6 bg-success-50 border border-success-200 rounded-xl p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-success-900">Property Created!</h3>
          ...
          <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label htmlFor="bedrooms" className="block text-sm font-medium text-neutral-700 mb-2">
                    Bedrooms <span className="text-neutral-500 text-xs">(optional)</span>
                  </label>
                  <input
                    id="bedrooms"
                    type="number"
                ...
                <div>
                  <label htmlFor="bathrooms" className="block text-sm font-medium text-neutral-700 mb-2">
                    Bathrooms <span className="text-neutral-500 text-xs">(optional)</span>
                  </label>
                  <input
                    id="bathrooms"
                    type="number"
                ...
                <div>
                  <label htmlFor="square_meters" className="block text-sm font-medium text-neutral-700 mb-2">
                    Floor Area (m²) <span className="text-neutral-500 text-xs">(optional)</span>
                  </label>
                  <input
                    id="square_meters"
                    type="number"
                ...
                <div className="md:col-span-2">
                  <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    />
                    <span className="text-sm font-medium text-neutral-700">Active (visible in listings)</span>
                  </label>
                </div>
              </div>
            </div>
            ...
            <div className="border-t border-neutral-200 pt-8">
              ...
              <div className="space-y-3">
                ...
                <p className="text-xs text-neutral-500">Add publicly accessible image URLs. Press Enter or click "Add URL" to add each one.</p>
              </div>
            </div>
