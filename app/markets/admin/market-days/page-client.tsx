      ...
      <div className="container-custom py-8">
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <h1 className="text-4xl font-bold text-neutral-900 mb-2">Market Day Planning</h1>
                ...
                {marketDays && marketDays.length > 0 ? (
                  marketDays.map((marketDay) => (
                    <tr key={marketDay.id} className="hover:bg-neutral-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${marketDay.is_published
