...
import { createEvent, CreateEventData } from '@/lib/actions/admin-crud'
...
export default function AdminEventCreatePageClient() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.message || 'Unexpected error creating event')
    } finally {
      setLoading(false)
    }
  }
    ...
    <main className="min-h-screen bg-neutral-50">
      ...
      <div className="container-custom max-w-4xl py-8">
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold text-neutral-900 mb-2">Add Event</h1>
            <p className="text-neutral-600">Create a new community event</p>
          </div>
        ...
        {success && (
          <div className="mb-6 bg-success-50 border border-success-200 rounded-xl p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-success-900">Event Created!</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-neutral-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                    placeholder="Market Day, Workshop, Festival..."
                  />
                </div>
                ...
                <div>
                  <label htmlFor="end_time" className="block text-sm font-medium text-neutral-700 mb-2">
                    End Time <span className="text-neutral-500 text-xs">(optional)</span>
                  </label>
                  <input
                    id="end_time"
                    type="time"
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-neutral-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                    placeholder="Sunday Market Grounds, Cebu City"
                  />
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="ticket_price" className="block text-sm font-medium text-neutral-700 mb-2">
                    Ticket Price (₱) <span className="text-neutral-500 text-xs">(leave blank if free)</span>
                  </label>
                  <input
                    id="ticket_price"
                    type="number"
                ...
                <div>
                  <label htmlFor="max_attendees" className="block text-sm font-medium text-neutral-700 mb-2">
                    Max Attendees <span className="text-neutral-500 text-xs">(optional)</span>
                  </label>
                  <input
                    id="max_attendees"
                    type="number"
                ...
                <div className="md:col-span-2">
                  <label htmlFor="ticket_url" className="block text-sm font-medium text-neutral-700 mb-2">
                    Ticket URL <span className="text-neutral-500 text-xs">(optional)</span>
                  </label>
                  <input
                    id="ticket_url"
                    type="url"
                ...
                <div className="md:col-span-2 flex items-center gap-6">
                  <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    />
                    <span className="text-sm font-medium text-neutral-700">Published (visible to the public)</span>
                  </label>
