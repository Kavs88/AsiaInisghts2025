...
export default function ConciergeHomePage() {
  return (
    <main id="main-content" className="min-h-screen bg-white">
      ...
      <section id="our-services" className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            {/* For Expats */}
            <div className="bg-white rounded-2xl p-8 border border-neutral-200 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
          ...
          {/* Single section-level CTA — replaces 4 competing card buttons */}
      ...
      <section className="py-12 bg-neutral-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto mb-10">
            {/* Da Nang, Vietnam */}
            <div className="bg-white rounded-2xl p-8 border border-neutral-200 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col items-center text-center">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="overflow-x-auto pb-4 -mx-4 px-4 scroll-smooth" style={{ scrollbarWidth: 'thin', scrollbarColor: '#cbd5e1 transparent' }}>
            <div className="flex gap-6 min-w-max">
              ...
              <div className="bg-white rounded-2xl p-8 sm:p-10 border border-neutral-200 shadow-sm hover:shadow-md transition-shadow w-[90vw] sm:w-[500px] flex-shrink-0">
                ...
                <p className="text-neutral-700 mt-6 italic text-lg leading-loose">
      ...
      {/* Get in Touch */}
      <section id="get-in-touch" className="py-12 bg-neutral-900 text-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-6 lg:mb-8">
              <h2 className="text-3xl lg:text-4xl font-black text-white mb-2 lg:mb-3">
                Get in Touch
              </h2>
              <p className="text-lg lg:text-xl text-neutral-400 font-medium max-w-2xl mx-auto">
                Contact us directly. We respond within one business day.
              </p>
            </div>
            ...
            <div className="max-w-2xl mx-auto">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                ...
                <a
                  ...
                  className="flex flex-col items-center justify-center gap-2 p-4 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-xl transition-all hover:shadow-lg hover:-translate-y-0.5"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center justify-center gap-2 p-4 bg-[#0068FF] hover:bg-[#0052CC] text-white rounded-xl transition-all hover:shadow-lg hover:-translate-y-0.5"
                >
                  <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  className="flex flex-col items-center justify-center gap-2 p-4 bg-primary-600 hover:bg-primary-700 text-white rounded-xl transition-all hover:shadow-lg hover:-translate-y-0.5"
                >
