...
export default function HubHero({
    ...
    return (
        <section className={cn(
            ...
            {/* Content Layer */}
            <div className={cn("max-w-7xl mx-auto px-6 lg:px-8 relative z-20 py-14 sm:py-20 lg:py-32", contentClassName)}>
                <div className="max-w-4xl animate-fade-up">
                    <h1 className={cn("text-3xl sm:text-5xl lg:text-7xl xl:text-8xl font-bold text-white mb-6 leading-[0.9] tracking-tight", titleClassName)}>
                        {title}
                    </h1>
